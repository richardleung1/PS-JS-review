...
const ozgur = 'Once upon a time Ozgur looked up at the Moon, and he transformed into a werewolf!'
// console.log(ozgur.includes('werewolf'))

// Help! I'm looking for my cow! Using c help Josh find his cow. What's the index of cow?
...
// unshift()
// add element to the front of array
// shift()
// remove first element from of array
// concat()
// returns a new array by merging two arrays
// splice()
...
// includes()
// returns a boolean showing if a value is in an array
// indexOf()
...
const exoticFruits = ['durian', 'lychee', 'dragonfruit']
...
function filterBadword(string) {
  const words = string.split(' ')
  let newArray = words.filter(word => word !== 'badword')
  return newArray.join(' ')
}
// console.log(filterBadword(RafaelNoBadWords))
...
let sum = numbersToAddUp.reduce(addNums, 0)
// console.log(sum)
// ===== SPREAD OPERATOR ===== 

// Create a variable and assign a value of a copied array using the spread operator
const nums = [...numbersToAddUp]
// console.log(nums)
// Create two arrays with any elements and connect both of them using the spread operator. Save the connected arrays into a new variable.
let exercisingHobbies = ['walking', 'hiking', 'running', 'biking']
let otherHobbies = ['cooking', 'reading', 'gardening', 'photography']
let hobbies = [...exercisingHobbies, ...otherHobbies]
// console.log(hobbies)
// Using the variable with the newly connected arrays, use spread operator to add something at the end.
hobbies = [...hobbies, 'meditation']
// console.log(hobbies)
...
let people = ['Teo', 'Manara', 'Liv', 'Devin', 'Richard']
// people.forEach(person => console.log(fightClub(person)))
